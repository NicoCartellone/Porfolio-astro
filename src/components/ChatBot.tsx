...
const ANSWERS = {
  ...
  contacto: (
    <p>
      ...
      <a 
        className="underline"
        href="mailto:nicolas.cartellone@gmail.com"
      >
        nicolas.cartellone@gmail.com
      </a>
      <br/>
      Ademas te dejo el enlace a mi <br />
      <a className="underline" href="src/assets/CV.pdf" target="_blank">Curriculum</a>
    </p>
  ),
  tecnologia: (
    <p>
...
export default function ChatBot({ apiKey }: Props) {
  ...
  return (
    <>
      {isChatOpen ? (
        <div className="bg-white flex flex-col gap-4 m-5 max-w-lg border border-gray-400 p-4 fixed bottom-5 md:right-10 z-50">
          <div className="flex flex-row justify-between gap-3 items-center">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-gray-500">en linea 🟢</p>
              </div>
            </div>
          ...
          <form className="flex items-center gap-1" onSubmit={handleSubmit}>
            <input
              ...
              className="rounded rounder-r-none flex-1 border border-gray-400 py-2 px-4"
              type="text"
              name="question"
            />
            <button
